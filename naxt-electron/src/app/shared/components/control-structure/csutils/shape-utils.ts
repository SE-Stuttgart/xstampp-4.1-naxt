...
export class ShapeUtils {
   ...
   */
  GrabHandles: Element = dia.Element.define(
    'xstampp.GrabHandles',
    {
      attrs: {
        body: {
  ...
  getShapeByName(shapeName: string): dia.Element {
    switch (shapeName) {
      ...
      case 'DashedBox': {
        const shape = new this.DashedBoxShape();
      ...
      case 'TextBox': {
        const shape = new this.TextBoxShape();
      ...
      case 'InputBox': {
        const shape = new this.InputBoxShape();
        /* Set text (needed for JSONify) */
        shape.attr({
          label: {
            text: 'Input',
      ...
      case 'OutputBox': {
        const shape = new this.OutputBoxShape();
        /* Set text (needed for JSONify) */
        shape.attr({
          label: {
            text: 'Output',
